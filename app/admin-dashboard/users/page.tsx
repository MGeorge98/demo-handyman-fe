...
const initialUsers = [
    { id: 1, name: "Ana Popescu", email: "ana.popescu@example.com", phone: "0722123456", role: "Manager", team: "Frontend", status: "Activ" },
    { id: 2, name: "Mihai Ionescu", email: "mihai.ionescu@example.com", phone: "0733234567", role: "Coordonator", team: "Backend", status: "Activ" },
    { id: 3, name: "Elena Dumitrescu", email: "elena.dumitrescu@example.com", phone: "0744345678", role: "Angajat", team: "Design", status: "Inactiv" },
    { id: 4, name: "Alexandru Popa", email: "alexandru.popa@example.com", phone: "0755456789", role: "Angajat", team: "Frontend", status: "Activ" },
    { id: 5, name: "Maria Stancu", email: "maria.stancu@example.com", phone: "0766567890", role: "Coordonator", team: "QA", status: "Activ" },
]
        ...
        <DashboardLayout links={adminLinks}>
            <div className="flex min-h-screen w-full flex-col bg-[#F4F7FA]">
                    ...
                    <div className="mx-auto max-w-6xl space-y-8">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Gestionați conturile de utilizator pentru manageri, coordonatori și angajați</CardDescription>
                            </CardHeader>
                            <CardContent>
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <DropdownMenu>
                                            <DropdownMenuTrigger asChild>
                                                <Button variant="outline">Filtrare</Button>
                                            </DropdownMenuTrigger>
                                            <DropdownMenuContent>
                                                ...
                                                <DropdownMenuSeparator />
                                                {["Frontend", "Backend", "Design", "QA"].map((team) => (
                                                    <DropdownMenuCheckboxItem
                                                        key={team}
                                ...
                                <ScrollArea className="h-[400px]">
                                    <Table>
                                        <TableHeader>
                                            <TableRow>
                                                <TableHead onClick={() => handleSort('name')} className="cursor-pointer">Nume</TableHead>
                                                <TableHead onClick={() => handleSort('email')} className="cursor-pointer">Email</TableHead>
                                                <TableHead onClick={() => handleSort('phone')} className="cursor-pointer">Telefon</TableHead>
                                                <TableHead onClick={() => handleSort('role')} className="cursor-pointer">Rol</TableHead>
                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>{currentUser ? "Editare Utilizator" : "Creare Utilizator Nou"}</DialogTitle>
                            <DialogDescription>
                        ...
                        <form onSubmit={(e) => {
                            ...
                            <div className="grid gap-4 py-4">
                                ...
                                <div className="grid grid-cols-4 items-center gap-4">
                                    ...
                                    <Select name="team" defaultValue={currentUser?.team || "Frontend"}>
                                        <SelectTrigger className="col-span-3">
